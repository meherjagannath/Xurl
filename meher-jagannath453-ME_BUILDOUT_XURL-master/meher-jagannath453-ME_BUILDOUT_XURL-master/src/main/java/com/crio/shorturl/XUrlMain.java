...
public class XUrlMain {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(url1); //2
    System.out.println(url2); //3
    System.out.println(url3); //4
    System.out.println(url4); //5
    ...
    System.out.println(url5); //6
    System.out.println(url6); //7
    System.out.println(urlNull); //8
    ...
    System.out.println(choppedUrl); //9
